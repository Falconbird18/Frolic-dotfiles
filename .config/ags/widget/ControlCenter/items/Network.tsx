...
export default () => {
  ...
  const wifiEnabled = bind(wifi, "enabled"); // ADDED wifiEnabled binding
  ...
  // Derive the button class name based on wifiEnabled
  const buttonClassName = bind(wifi, "enabled").as((enabled) =>
